...
(function () {
    ...
    const I18N = {
        pt: {
            ...
            'faq.6.a': 'Execute o comando <code>curl -fsSL https://cdn.jsdelivr.net/gh/zonaro/BigLinuxCleaner@main/install.sh | bash -s -- --uninstall</code> (ou baixe o <code>install.sh</code> e rode <code>./install.sh --uninstall</code>). Ele remove o atalho <code>.desktop</code> e o ícone instalado, tanto do Menu quanto da Área de trabalho.',
        ...
        en: {
            ...
            'faq.6.a': 'Run the command <code>curl -fsSL https://cdn.jsdelivr.net/gh/zonaro/BigLinuxCleaner@main/install.sh | bash -s -- --uninstall</code> (or download <code>install.sh</code> and run <code>./install.sh --uninstall</code>). It removes the <code>.desktop</code> shortcut and the installed icon, from both the Menu and the Desktop.',
        ...
        es: {
            ...
            'faq.6.a': 'Ejecuta el comando <code>curl -fsSL https://cdn.jsdelivr.net/gh/zonaro/BigLinuxCleaner@main/install.sh | bash -s -- --uninstall</code> (o descarga <code>install.sh</code> y ejecuta <code>./install.sh --uninstall</code>). Elimina el acceso directo <code>.desktop</code> y el icono instalado, tanto del Menú como del Escritorio.',
