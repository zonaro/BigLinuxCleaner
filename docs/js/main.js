...
(function () {
    ...
    const I18N = {
        pt: {
            ...
            'inst.cmd1.desc': 'O atalho abre no terminal, roda a limpeza e permanece aberto até você pressionar Enter.',
        ...
        en: {
            ...
            'inst.cmd1.desc': 'The shortcut opens a terminal, runs the cleanup and stays open until you press Enter.',
        ...
        es: {
            ...
            'inst.cmd1.desc': 'El acceso directo abre una terminal, ejecuta la limpieza y permanece abierto hasta que pulses Enter.',
